...
(function(){
    ...
    var lake={
        ...
        mutation:function(fn){
            return new _mo(fn);
        },
        match:function(element,selector,fn,basement){
        ...
        listen:function(target,event,fn,capture){
        ...
        listener:function(selector,event,fn,capture){
